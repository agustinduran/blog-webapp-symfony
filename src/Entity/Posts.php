...
class Posts
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Comentarios::class, mappedBy="id_post", orphanRemoval=true)
     */
    private $comentarios;
    ...
    public function removeComentario(Comentarios $comentario): self
    {
        if ($this->comentarios->removeElement($comentario)) {
            ...
            if ($comentario->getIdPost() === $this) {
                $comentario->setIdPost(null);
            }
        }
